...
import com.example.test.designpatterns.singleton.CEO;
import com.example.test.designpatterns.singleton.Company;
import com.example.test.designpatterns.singleton.Singleton;
import com.example.test.designpatterns.singleton.Staff;
import com.example.test.designpatterns.singleton.VP;
